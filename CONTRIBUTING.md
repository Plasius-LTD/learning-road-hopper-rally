# Contributing to @plasius/learning-road-hopper-rally
...
`@plasius/learning-road-hopper-rally` provides immutable course content,
portable project and frame contracts, deterministic gameplay, original assets,
bounded QuickJS evaluation, and server-only assessment for Road Hopper Rally.

Contributions typically cover curriculum, validators, deterministic mechanics,
sandbox safety, original assets, accessibility, documentation, and tests. React,
HTTP, authentication, persistence, entitlements, and cloud infrastructure belong
in their adapter repositories rather than this package.
